...
ALL_OBJECTS = tdci.o units.o setup_variables.o control_variables.o variables_global.o write_info.o read_integrals.o initialize.o getfield.o util.o getham0_cisd.o getham0.o getham.o propagate.o Zpropagate.o analysis.o davidson_ip.o 


all : update tdci clean
...
getham0.o : mod_getham0.f90 variables_global.o read_integrals.o 
	$(FC) $(FFLAGS) $(OPT_FLAGS) $(LAPACK_LIBS) -c mod_getham0.f90 -o getham0.o

getham0_cisd.o : mod_getham0_cisd.f90 variables_global.o read_integrals.o
	$(FC) $(FFLAGS) $(OPT_FLAGS) $(LAPACK_LIBS) -c mod_getham0_cisd.f90 -o getham0_cisd.o

getfield.o : mod_getfield.f90 variables_global.o 
	$(FC) $(FFLAGS) $(OPT_FLAGS) $(LAPACK_LIBS) -c mod_getfield.f90 -o getfield.o

initialize.o : mod_initialize.f90 read_integrals.o variables_global.o 
...
write_info.o : mod_write.f90 units.o setup_variables.o control_variables.o variables_global.o
